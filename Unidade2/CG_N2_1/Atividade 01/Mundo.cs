  ...
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      #region Objeto: circulo
        ...
        //Um circulo tem 360º 
        //Professor pediu pontos de tamanho 5, então se dividirmos 360 graus por 5, teremos os 72 pontos do professor
        //Utilizamos um LOOP incrimental, e a classe MATEMATICA, para calcular o seno e cos do circulo

        var calculo = Matematica.GerarPtosCirculo(05, 0.50);
        
        for (int i = 0; i <= 360; i = i + 5){
          calculo = Matematica.GerarPtosCirculo(i, 0.50);
          objetoSelecionado = new Circulo(mundo, ref rotuloAtual, new Ponto4D(calculo.X, calculo.Y));
        }
