...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      //pontosPoligono.Add();
      //objetoSelecionado = new Poligono(mundo, renew Ponto4D(0.25, 0.75)f rotuloAtual, pontosPoligono);
      #endregion
      ...
      objetoSelecionado = new SegReta(mundo, ref rotuloAtual, new Ponto4D(0, 0), new Ponto4D(0.50, 0.50));
      pontoAtual = Matematica.GerarPtosCirculo(45, 0.5);
      #endregion
    ...
    protected override void OnUpdateFrame(FrameEventArgs e){
      ...
      if (input.IsKeyDown(Keys.Escape))
      {
        ...
        if(input.IsKeyPressed(Keys.A)){
          ...
          double yNovoAtu = objetoSelecionado.PontosId(1).Y - 0.05;
          double xAtu = objetoSelecionado.PontosId(1).Y;

          objetoSelecionado.PontosAlterar(new Ponto4D(yNovoAtu, yNovoAtu), 1);
          ...
          double xNovoAtu = objetoSelecionado.PontosId(0).X + 0.05;
          double yNovoAtu = objetoSelecionado.PontosId(1).X + 0.05;

          double yAtuUm = objetoSelecionado.PontosId(0).Y;
          double yAtuDois = objetoSelecionado.PontosId(1).Y;

          objetoSelecionado.PontosAlterar(new Ponto4D(xNovoAtu, yAtuUm), 0);
          objetoSelecionado.PontosAlterar(new Ponto4D(yNovoAtu, yAtuDois), 1);
          objetoSelecionado.ObjetoAtualizar();
          ...
          anguloAtual = anguloAtual - 5;
          var ponto4 = Matematica.GerarPtosCirculo(anguloAtual, 0.50);
          
          objetoSelecionado.PontosAlterar(new Ponto4D(ponto4.X, ponto4.Y), 1);
          objetoSelecionado.ObjetoAtualizar();
